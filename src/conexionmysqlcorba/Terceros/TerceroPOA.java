 ...
 implements Terceros.TerceroOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("shutdwn", new java.lang.Integer (4));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // Terceros/Tercero/insertarTercero
       {
         ...
         $result = this.insertarTercero (nombre, apellidos, telefono);
         out = $rh.createReply();
       ...
       case 1:  // Terceros/Tercero/actualizarTercero
       {
         ...
         String telefono = in.read_wstring ();
         boolean $result = false;
         $result = this.actualizarTercero (id, nombre, apellidos, telefono);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
       ...
       case 4:  // Terceros/Tercero/shutdwn
       {
         this.shutdwn ();
         out = $rh.createReply();
         break;
